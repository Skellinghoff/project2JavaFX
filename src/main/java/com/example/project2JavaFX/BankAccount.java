...
public class BankAccount implements Serializable {
    ...
    * @exception NegativeStartingBalanceException When startBalance is negative.
    */
    ...
    * @exception NegativeDepositException When amount is negative.
    */
    ...
    * @exception NegativeWithdrawalException When amount is negative.
    * @exception OverdrawException When amount is greater than the account balance.
    */
    ...
    * @exception NegativeBalanceSetException When balance is negative
    */
